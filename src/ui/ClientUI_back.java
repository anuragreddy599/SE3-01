...
public class ClientUI_back extends javax.swing.JDialog {
	...
	/*private int addNew() throws SQLException {
		...
		newObj.addCourse(txtNumber.getText(), txtName.getText(),
				...
				txtAddress2.getText(), txtCity.getText(), txtState.getText(),
	...
	private boolean updateRecord() throws SQLException {
		...
		boolean bool = newObj.editCourse(txtNumber.getText(),
				...
				txtAddress1.getText(), txtAddress2.getText(), txtCity.getText(),
				txtState.getText(), txtEmail.getText(), txtZip.getText());
...
*/
					...
					public void valueChanged(ListSelectionEvent event) {
						try {
							if (jTable1.getSelectedRow() >= 0) {
								...
								Object txtCityV = jTable1.getValueAt(
										jTable1.getSelectedRow(), 6);
								Object txtStateV = jTable1.getValueAt(
										jTable1.getSelectedRow(), 7);
								Object txtEmailV = jTable1.getValueAt(
										jTable1.getSelectedRow(), 8);
								Object txtZipV = jTable1.getValueAt(
								...
								txtCity.setText(txtCityV.toString());
								txtState.setText(txtStateV.toString());
								txtEmail.setText(txtEmailV.toString());
								txtZip.setText(txtZipV.toString());
							}
						} catch (Exception ex) {
	...
	public ClientUI_back(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	}
	...
	private void initComponents() {
		...
		txtBillingTerm = new javax.swing.JTextField();
		txtInvoiceGrouping = new javax.swing.JTextField();
		jLabelBillingTerm = new javax.swing.JLabel();
		jLabelInvoiceGrouping = new javax.swing.JLabel();
		...
		jLabelAddress1.setText("Address1:");

		// desc.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
		// "Male", "Female" }));

		jLabelAddress2.setText("Address2 :");
		...
		jLabelInvoiceFreq.setText("Invoice Freq :");
		jLabelBillingTerm.setText("BillingTerm :");
		jLabelInvoiceGrouping.setText("InvoiceGrouping :");
		...
		jTable1.setModel(new javax.swing.table.DefaultTableModel(
				new Object [][] {
		            ...
		            new String [] {
		                "Title 1", "Title 2", "Title 3", "Title 4", "Title 5", "6", "null7", "8null", "9", "10", "11", "12"
		            }
		        ));
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(ClientUI_back.class.getName()).log(
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				ClientUI_back dialog = new ClientUI_back(new javax.swing.JFrame(), true);
	...
	private javax.swing.JTextField txtInvoiceFreq;
	private javax.swing.JTextField txtBillingTerm;
	private javax.swing.JTextField txtInvoiceGrouping;
